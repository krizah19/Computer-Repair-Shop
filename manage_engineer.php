...
{	
	...
	{		
		...
		echo '<script>window.location.href="manage_engineer.php?admin_id='.$admin_id.'&msg=success"</script>';
	...
	if($rowsChk!=0)
	{
		echo '<script>window.location.href="manage_engineer.php?msg=error"</script>';
		exit;
	}					
		...
		echo '<script>window.location.href="manage_engineer.php?msg=success"</script>';
	}		
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">        
	  ...
	  <h2><?php echo $caption; ?> Engineer</h2>
		  ...
		  <table class="table table-striped">		  
			<tr>
			  ...
			  <select name="admin_type" id="admin_type" class="textbox1" style="width:258px; height:32px;" validate="{required:true,messages:{required:'Please select User Type.'}}">			  	
				...
				<OPTION  value="Engineer" <?php if($row_user['admin_type']=='Engineer') echo 'selected';?>>Engineer</OPTION>
			  </select>
			  </td>
			</tr>
			...
			<tr>
			  ...
			  <td><input name="admin_login" type="text" class="textbox1" id="admin_login" value="<?php echo $row_user['admin_login']; ?>" style="width:250px;" <?php if($admin_id) { ?> readonly<?php } ?> validate="{required:true,messages:{required:'Please enter user name.'}}" /></td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td><table class="table table-striped">
										...
										<tr>
										  ...
										  <?php echo $userpermArr[$j]; ?><?php }else{?>&nbsp;<?php }?>
										  </td>
										  <?php }?>
										</tr>
										<?php }?>
		  ...
		  <a href="all_engineer.php"><button type="button" class="btn btn-lg btn-primary">Back</button></a>
		  </div>
